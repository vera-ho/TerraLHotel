...
Hotel.create({      
    ...
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel001_th_aw5nfu.jpg", img2: ""
}) # building_id: 1

Hotel.create({
    name: "Made Hotel", country: "USA", state: "NY", city: "New York City", address: "44 W 29th St" , rooms: 108,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel002_th_crp9jh.jpg", img2: ""
}) # building_id: 2

Hotel.create({
    name: "Sixty Soho", country: "USA", state: "NY", city: "New York City", address: "60 Thompson Street" , rooms: 100,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel003_th_ttsnkl.jpg", img2: ""
}) # building_id: 3

Hotel.create({
    name: "The Carlyle", country: "USA", state: "NY", city: "New York City", address: "35 East 76th Street" , rooms: 190,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel009_th_ohnp2k.jpg", img2: ""
}) # building_id: 4

Hotel.create({
    name: "Mint House", country: "USA", state: "NY", city: "New York City", address: "25 W 39th Street, Suite 700" , rooms: 155,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel013_th_m9eku7.jpg", img2: ""
}) # building_id: 5

Hotel.create({
    name: "Shonai Hotel Suiden Terrasse", country: "Japan", state: "", city: "Yamagata", address: "Kitakyoden Shimotorinosu 23-1", rooms: 135,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel004_th_afyxyx.jpg", img2: ""
}) # building_id: 6

Hotel.create({
    name: "The Edwin Hotel", country: "USA", state: "NY", city: "Chattanooga", address: "102 Walnut Street, Chattanooga, TN", rooms: 90,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel008_th_firzfl.jpg", img2: ""
}) # building_id: 7

Hotel.create({
    name: "San Canzian Village & Hotel", country: "Croatia", state: "", city: "Buje", address: "Mužolini Donji 7, Buje", rooms: 24,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel005_th_lbmlrp.jpg", img2: ""
}) # building_id: 8

Hotel.create({
    name: "Cervo Mountain Resort", country: "Switzerland", state: "", city: "Zermatt", address: "Riedweg 156, Postfach 388", rooms: 54,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel006_th_kgd6o0.jpg", img2: ""
}) # building_id: 9

Hotel.create({
    name: "Hotel des Trois Vallees", country: "France", state: "", city: "Courchevel", address: "Rue Park City", rooms: 31,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel012_th_mftnx1.jpg", img2: ""
}) # building_id: 10

Hotel.create({
    name: "Forestis Dolomites", country: "Italy", state: "", city: "Plose", address: "39042 Bressanone Bolzano, ", rooms: 60,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134998/hotel007_th_cjbtf2.jpg", img2: ""
}) # building_id: 11

Hotel.create({
    name: "Higashiyama Niseko Village", country: "Japan", state: "", city: "Niseko", address: "Aza Soga 919-28", rooms: 50,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel015_th_lmhuzv.jpg", img2: ""
}) # building_id: 12
...
Hotel.create({
    ...
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel014_th_vy6akq.jpg", img2: ""
}) # building_id: 13
...
Hotel.create({
    ...
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel011_th_tosbvd.jpg", img2: ""
}) # building_id: 14

Hotel.create({
    name: "Hotel Awa", country: "Chile", state: "", city: "Puerto Varas", address: "Ruta 225, Km. 27", rooms: 16,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel010_th_vpqy9n.jpg", img2: ""
}) # building_id: 15

Hotel.create({
    name: "Zannier Hotels Omaanda", country: "Namibia", state: "", city: "Windhoek East", address: "Omaanda Lodge, Farm n° 78", rooms: 10,
    img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732134999/hotel016_th_uavugj.jpg", img2: ""
}) # building_id: 16
...
Room.create({ room_type: "Deluxe Room", beds: "1 double/full bed" , occupancy: 2, size: "215 ft²/20 m²", building_id: 1, 
     img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732135000/room001_th_lil1fx.jpg"})
Room.create({ room_type: "Standard Room", beds: "2 Single Beds or 1 King Bed", occupancy: 2, size: "215 ft²/20 m²", building_id: 1,
     img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732135000/room002_th_bqnfgi.jpg"})

# 3
Room.create({ room_type: "Prestige Suite with Private Pool", beds: "1 King Bed", occupancy: 2, size: "807 ft²/75 m²", building_id: 2,
     img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732135000/room004_th_yjfzj4.jpg"})

# 4, 5, 6
Room.create({ room_type: "Muse", beds: "1 Queen Bed", occupancy: 2, size: "215 ft²/20 m²", building_id: 3,
     img1: "https://res.cloudinary.com/dmlsllmse/image/upload/v1732135000/room005_th_drpmkh.jpg"})
